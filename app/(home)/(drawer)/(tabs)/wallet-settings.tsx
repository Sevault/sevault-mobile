    ...
    <ScrollView style={styles.settingsContainer}>
      ...
      <View style={{ marginTop: actuatedNormalizeVertical(20) }}>
        ...
        <Pressable
          ...
          style={{ backgroundColor: COLORS.BLACK_ACCENT, height: actuatedNormalize(42), marginTop: actuatedNormalizeVertical(10), alignItems: 'center', justifyContent: 'center', borderRadius: 11 }}>
          ...
          <View style={styles.modalView}>
            <View style={styles.animatedImageContainer}>
              <Image
                ...
                style={{ height: actuatedNormalize(80), width: actuatedNormalize(80) }}
              />
            </View>
            <View style={styles.messageContainer}>
              <Text style={[styles.messageTitle, { fontFamily: fontsLoaded ? 'Poppins_600SemiBold' : '' }]}>
